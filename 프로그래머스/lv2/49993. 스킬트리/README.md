...
<ul>
<li>예를 들어, <code>C → B → D</code> 라면 "<em class="Highlight" match="cbd" loopnumber="332525627" style="padding: 1px; box-shadow: rgb(229, 229, 229) 1px 1px; border-radius: 3px; -webkit-print-color-adjust: exact; background-color: rgb(255, 255, 102); font-style: inherit;">CBD</em>"로 표기합니다</li>
</ul></li>
...
<th>return</th>
        ...
        <tbody><tr>
<td><code>"<em class="Highlight" match="cbd" loopnumber="332525627" style="padding: 1px; box-shadow: rgb(229, 229, 229) 1px 1px; border-radius: 3px; -webkit-print-color-adjust: exact; background-color: rgb(255, 255, 102); font-style: inherit;">CBD</em>"</code></td>
